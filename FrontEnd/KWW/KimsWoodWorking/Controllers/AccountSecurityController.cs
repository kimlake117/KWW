...
using KimsWoodWorking.Providers;
using KimsWoodWorking.Results;
...
namespace KimsWoodWorking.Controllers
{
    ...
    public class AccountSecurityController : ApiController
    {
        ...
        public AccountSecurityController(ApplicationUserManager userManager,
